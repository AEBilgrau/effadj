...
% Title of paper
\title{Variance approximation of the amplification efficiency in qPCR experiments}
...
The approach is used demonstrate that multiple myeloma cancer cell lines differentially express the MGST1 gene depending on the frequency of culture initiating cells.
