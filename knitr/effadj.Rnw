...
The samples were collected in accordance with a research protocol accepted by the Health Research Ethics Commmittee for North Denmark Region (No.~N-20100059).
...
Lastly, we note that the algorithm \citep{Mx300P2013} we used for threshold selection and $C_q$-value extraction in the CIC and DLBCL studies may not be optimal, cf.~\citep{Ruijter2013}, as it can be affected by the AE.
