...
In all instances, the mean of the bootstrap distribution agree well with the obtained using the delta or Monte Carlo methods while the bootstrap scheme seems to provide a larger standard deviation.
