...
% Title of paper
\title{Variance approximations of amplification efficiency corrected relative
       gene expression values in qPCR experiments}
...
Lastly, the methods are bench-marked in a simulation study.
}
% Keywords
