...
qPCR is an extremely sensitive and cost-effective technique to amplify and quantitate the abundance of DNA and even mRNA by using so-called reverse transcriptase and polymerase followed by polymerase chain reaction via Taq polymerase.
...
$\sigma$ is a sample-specific error and
