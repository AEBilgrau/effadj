...
J.S. B{\O}DKER$^1$,  H.E. JOHNSEN$^1$, K. DYBK{\AE}R$^1$, P.S. ERIKSEN$^2$, M. B{\O}GSTED$^1$\\[4pt]
% Author addresses
...
\subsubsection{Sample and data preparation}
The arabidopsis thaliana plant growth, RNA extraction, and qPCR experiments were carried out as described in \citet{Yang2006}. The cDNA was diluted into 1:4 and 1:16 serial dilutions. Real-time PCR experiments was performed in duplicates for each concentration \citep{Yuan2008}.
